/**
 * Minimal investor ask slide template component.
 *
 * A presentation slide template for fundraising ask slides with an ultra-minimal
 * design. Designed for investor pitch decks.
 */
 ...
 */
export const layoutId = "minimal-investor-ask";
 ...
 */
export const layoutDescription = "Ultra-minimal fundraising ask slide.";
...
const askSchema = t({
  ...
  amount: t("2<=string<=20").describe("Fundraising amount").default("$5M Seed"),
  ...
  milestones: t({
    ...
    .default(() => [
      { title: "$4M ARR", date: "Q4 2026" },
      { title: "100 customers", date: "Q2 2027" },
    ]),
});
...
/**
 * Minimal investor ask slide component.
 *
 * Renders an ultra-minimal fundraising ask slide.
