/**
 * Product narrative traction slide template component.
 *
 * A presentation slide template for traction slides with a dark, cinematic design
 * featuring prominent growth metrics and MRR chart. Uses Recharts for data visualization.
 * Designed for product narrative presentations.
 */
 ...
 */
export const layoutId = "product-narrative-traction";
...
export const layoutDescription =
  "Dark traction slide with prominent growth metrics.";

/**
 * Schema definition for traction slide data.
 */
const tractionSchema = t({
  title: t("3<=string<=60").describe("Traction title").default("Growing fast"),
  metrics: t({
    label: t("2<=string<=30"),
    value: t("1<=string<=12"),
    ...
    .default(() => [
      { label: "Active Users", value: "48K", change: "+22% MoM" },
      { label: "Retention", value: "84%", change: "D30" },
      { label: "NPS", value: "72", change: "+12 pts" },
    ]),
  chartData: t({
    month: t("2<=string<=6"),
    mrr: t("number"),
...
/**
 * Product narrative traction slide component.
 *
 * Renders a dark traction slide with prominent growth metrics and MRR chart.
