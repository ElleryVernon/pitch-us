/**
 * Vision bold team slide template component.
 *
 * A presentation slide template for team slides with a bold design featuring
 * gradient accents. Designed for impactful presentations.
 */
 ...
 */
export const layoutId = "vision-bold-team";
 ...
 */
export const layoutDescription = "Bold team slide with gradient accents.";
...
const teamSchema = t({
  ...
  members: t({
    ...
    .default(() => [
      ...
      },
      {
        name: "Lisa Chen",
        role: "CTO",
        background: "Ex-Meta AI Research, MIT",
      },
      {
        name: "James Kim",
        role: "COO",
        background: "Ex-Databricks, scaled to IPO",
      },
    ]),
  advisors: t("4<=string<=40")
    ...
    .and(t("2<=unknown[]<=3"))
    .describe("Advisors")
    .default(() => ["Former CTO, Snowflake", "AI Lead, Microsoft"]),
});
...
/**
 * Vision bold team slide component.
 *
 * Renders a bold team slide with gradient accents.
