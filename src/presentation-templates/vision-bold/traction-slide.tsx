/**
 * Vision bold traction slide template component.
 *
 * A presentation slide template for traction slides with a bold design featuring
 * gradient metrics and MRR chart. Uses Recharts for data visualization.
 ...
 */
export const layoutId = "vision-bold-traction";
 ...
 */
export const layoutDescription = "Bold traction slide with gradient metrics.";
...
const tractionSchema = t({
  ...
  metrics: t({
    ...
    .default(() => [
      { label: "ARR", value: "$12M", change: "+140% YoY" },
      { label: "Net Retention", value: "145%", change: "+15 pts" },
      { label: "Enterprise Customers", value: "84", change: "+32 QoQ" },
    ]),
  chartData: t({
    month: t("2<=string<=6"),
    mrr: t("number"),
...
/**
 * Vision bold traction slide component.
 *
 * Renders a bold traction slide with gradient metrics and MRR chart.
